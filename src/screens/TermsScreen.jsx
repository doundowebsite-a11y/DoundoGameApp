...
const TermsScreen = ({ navigation }) => {
  ...
  // DECLINE: close the app entirely
  const handleDecline = () => {
    Alert.alert(
      'Are you sure?',
  ...
  // ACCEPT: save to DB, refreshProfile triggers navigator re-render
  const handleAccept = async () => {
    ...
    if (!error) {
      ...
      // AppNavigator will automatically advance to ProfileSetup or Home
      // based on the updated profile.terms_accepted and profile.username values
    }
    setLoading(false);
  };
...
const styles = StyleSheet.create({
  ...
  boxContainer: {
    ...
    borderWidth: 1, borderColor: 'rgba(37, 106, 244, 0.1)',
  ...
  acceptanceSection: {
    borderTopWidth: 1, borderColor: 'rgba(37, 106, 244, 0.1)',
    paddingTop: 32, alignItems: 'center', marginBottom: 24, gap: 12,
  },
