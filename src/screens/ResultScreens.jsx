...
import { IconHome, IconShare } from '../assets/icons/icons';
...
export const WinScreen = ({ navigation, route }) => {
  ...
  const totalCards = params.totalCards || 0;
    ...
    <View style={[styles.container, { paddingTop: insets.top, paddingBottom: insets.bottom }]}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.titleContainer}>
          ...
          <Text style={styles.subtitleText}>Doundo Champion</Text>
        </View>

        <View style={styles.avatarSection}>
          <View style={styles.avatarWrapper}>
             <Image source={require('../assets/icons/card_back.svg')} style={styles.avatarImg} />
        ...
        <View style={styles.actionsContainer}>
          <TouchableOpacity style={styles.primaryBtn} onPress={() => navigation.navigate('LevelSelect')}>
    ...
    <View style={[styles.container, { paddingTop: insets.top, paddingBottom: insets.bottom }]}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={StyleSheet.absoluteFillObject} pointerEvents="none">
            <LottieView
              source={require('../animations/crying.json')}
              autoPlay
              loop
              style={{ width: '100%', height: '50%', opacity: 0.8, top: '10%' }}
            />
        </View>

        <View style={styles.avatarSection}>
          <View style={[styles.avatarWrapper, { borderColor: theme.colors.status.error }]}>
             <Image source={require('../assets/icons/card_back.svg')} style={[styles.avatarImg, { opacity: 0.5 }]} />
          </View>
          <Text style={[styles.victoryText, { color: theme.colors.status.error, marginTop: 16 }]}>DEFEAT</Text>
          <Text style={styles.subtitleText}>Better luck next time, warrior</Text>
        </View>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={StyleSheet.absoluteFillObject} pointerEvents="none">
            <LottieView
              ...
              autoPlay
              loop
              style={{ width: '100%', height: '50%', opacity: 0.5, top: '20%' }}
            />
        </View>
        ...
        <View style={styles.drawAvatars}>
          <View style={styles.avatarWrapperSmall}>
             <Image source={require('../assets/icons/card_back.svg')} style={styles.avatarImg} />
             <View style={styles.drawBadge}><Text style={styles.drawBadgeText}>{username.toUpperCase()}</Text></View>
          </View>
          <Text style={styles.vsText}>VS</Text>
          <View style={[styles.avatarWrapperSmall, { borderColor: '#334155' }]}>
             <Image source={require('../assets/icons/card_back.svg')} style={styles.avatarImg} />
             <View style={[styles.drawBadge, { backgroundColor: '#334155' }]}><Text style={styles.drawBadgeText}>OPPONENT</Text></View>
          </View>
        </View>
