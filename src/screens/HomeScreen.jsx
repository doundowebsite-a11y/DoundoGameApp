      ...
      <ScrollView contentContainerStyle={styles.scrollContent} bounces={false}>
           ...
           <View style={styles.cardContent}>
              <View style={styles.levelCircleContainer}>
                 <Svg width="80" height="80" viewBox="0 0 80 80" style={{ transform: [{ rotate: '-90deg' }] }}>
                    ...
                    <Circle cx="40" cy="40" r="36" stroke={theme.colors.primary} strokeWidth="4" fill="transparent" strokeDasharray="226" strokeDashoffset={(1 - xp/100) * 226} strokeLinecap="round" />
                 </Svg>
        ...
        <View style={styles.sectionContainer}>
           ...
           <View style={styles.modesContainer}>
              ...
              <TouchableOpacity style={styles.humanModeCard} activeOpacity={0.9}>
                 <View style={styles.humanModeGradient} />
                 <Text style={[styles.iconTextLarge, { color: '#FFF' }]}>👥</Text>
                 <Text style={styles.modeTitleText}>PLAY AGAINST HUMAN</Text>
                 <View style={styles.playersOnlineBadge}>
                    <View style={[styles.statusDot, { backgroundColor: '#4ADE80' }]} />
                    <Text style={styles.playersOnlineText}>1,204 PLAYERS ONLINE</Text>
                 </View>
              </TouchableOpacity>
